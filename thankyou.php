...
<div class="thanks" style="margin-top: 20px; margin-bottom: 40px; text-align: center">
	<img src="img/bootup.png" alt="Boot Up" style="width: 200px;">
	<h1 style="color: #666666; text-align: center;">THANK YOU FOR CONTACTING US</h1>
	<a href="all-products.php">CLICK HERE TO VIEW MORE PRODUCTS ></a>
</div>
