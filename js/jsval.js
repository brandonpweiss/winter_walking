...
this.err_select="Please select a valid value for \"%FIELDNAME%\"";
...
switch(regx){
case "JSVAL_RX_EMAIL":
return((/^[0123456789a-zA-ZüöäßÄÖÜ]+([\.-]?[0123456789a-zA-ZüöäßÄÖÜ]+)*@[0123456789a-zA-ZüöäßÄÖÜ]+([\.-]?[0123456789a-zA-ZüöäßÄÖÜ]+)*(\.\w{2,5})+$/).test(value));
case "JSVAL_RX_TEL":
